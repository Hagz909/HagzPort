...
export default function RegisterPage() {
  ...
  return (
    <div 
      ...
      className={`relative flex min-h-screen items-center justify-center px-4 py-12 overflow-hidden transition-colors duration-700 ${isDark ? 'bg-zinc-950' : 'bg-slate-50'}`}
      style={{
